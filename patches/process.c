...
static inline DWORD call_process_entry( PEB *peb, LPTHREAD_START_ROUTINE entry )
{
    ...
    memcpy(__wine_main_argv[__wine_main_argc-2], env, sizeof(jmp_buf));
    sprintf(__wine_main_argv[__wine_main_argc-1], "%p", &longjmp);
    
    printf("proxywine: Call winmain\n");
    return entry( peb );
